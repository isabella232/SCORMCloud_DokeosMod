...
////////////
 ...
 //////added for cloud $dsp_cloudProps to the output         
	    echo $dsp_line.$dsp_progress.$dsp_desc.$dsp_export.$dsp_edit.$dsp_build.$dsp_visible.$dsp_publish.$dsp_reinit.$dsp_default_view.$dsp_debug.$dsp_cloudProps.$dsp_delete.$dsp_disk.$dsp_order;
