	...
	/// added for cloud: lp.default_view_mod
			...
			if(Database::num_rows($resultLearnpath)>0)
			{
                ...
                ///// updated for cloud 
							...
							?>
							<a href="<?php echo $detailsUrl ?>?course=<?php echo Security::remove_XSS($_GET['course']) ?>&origin=<?php echo Security::remove_XSS($_GET['origin']) ?>&lp_id=<?php echo $a_learnpath['id']?>&student_id=<?php echo $a_infosUser['user_id'] ?>">
               <?php //////////////////
               ?>
